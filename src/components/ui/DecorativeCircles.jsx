export default function DecorativeCircles() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      {/* Animated circles - black to match project theme (same structure as reference) */}
      {[...Array(8)].map((_, i) => {
        const sizes = [
        ...
        return (
          ...
          >
            <div className="w-full h-full rounded-full blur-sm bg-[#111827]" />
          </div>
        );
      })}
      ...
      {[...Array(12)].map((_, i) => {
        ...
        return (
          ...
          >
            <div className="w-full h-full rounded-full bg-[#111827] shadow-lg shadow-black/30" />
          </div>
        );
      })}
    </div>
