...
export default function CategoryBanner() {
  return (
    ...
    absolute 
       hidden sm:block right-0 sm:right-0 md:-right-16 lg:-right-10 
  ...
  "
      >
        <Image
          ...
          width={658}
          height={376}
          className="max-w-[90vw] sm:w-100 sm:h-60 md:w-120 md:h-70 lg:w-[658px] lg:h-[376px] h-auto"
        />
      </span>
      ...
      <span
       ...
       block text-[18px] leading-[20px] 
       absolute 
           hidden sm:block left-0 sm:left-0 md:-left-16 lg:-left-30 
          bottom-0 sm:-bottom-13 md:-bottom-18 lg:-bottom-25
     "
      >
        <Image
