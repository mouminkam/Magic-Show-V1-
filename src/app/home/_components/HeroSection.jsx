 ...
 * Displays the hero section with title, image, and social media links
 * @param {Object} props - Component props
 * @param {Object} props.heroData - Hero section data
 * @param {string} props.heroData.title - Hero title text
 * @param {string} props.heroData.image - Hero image path
 * @param {Array} props.heroData.socialLinks - Array of social media links
 */
export default function HeroSection({ heroData = null }) {
  ...
  const title = heroData?.title || "BACK TO DREAM";
  const imageSrc = heroData?.image || "/images/img27.png";
  const socialLinks = heroData?.socialLinks || defaultSocialLinks;
